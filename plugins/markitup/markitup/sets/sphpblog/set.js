...
mySettings = {
	...
	markupSet: [
		...
		{separator:'---------------' },		
		{name:'Center', key:'C', openWith:"[center]", closeWith:"[/center]"}, 
		{separator:'---------------' },		
		...
		{separator:'---------------' },
//		{name:'Picture', key:"P", replaceWith:'[img=[![Source URL:!:http://]!] popup=[![Popup full size?:!:false]!] float=[![Float (left/right):!:left]!] alt=[![Alt text]!]]'}, 
		{name:'Picture', key:"P", replaceWith:'[img=[![Source URL:!:http://]!] popup=[![Popup full size?:!:false]!] float=[![Float (left/right):!:left]!]'}, 
