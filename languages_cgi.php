<?php
	...
	if ( array_key_exists( 'blog_language1', $_POST ) ) {
		...
		if ( array_key_exists( 'store_data', $_GET ) ) {
			...
			require_once('languages/' . preg_replace("/[^a-z0-9-]/i", "", $_GET['lang2']) . '/strings.php');
	...
	function page_content() {
		...
		$GLOBALS['lang_string']['title'] = "Results";
		$GLOBALS['lang_string']['instructions'] = "Here are your results.";
