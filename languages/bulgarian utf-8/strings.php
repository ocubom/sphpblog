<?php
    // Bulgarian UTF-8 Language Translation
    ...
    $lang_string['menu_commentmoderation'] = "Unmodded Comments";
    ...
    $lang_string['sb_admin'] = 'Administrator';
    ...
    if ( $page == 'add' || $page == 'add_static' || $page == 'comments' || $page == 'add_block' ) {
      $lang_string['chk_visiblemenu'] = "Visible (Show in menu)"; // 0.5.0
    ...
    switch ($page) {
      ...
      case 'comments':
        ...
        $lang_string['success'] = "<h2>Comments Saved!</h2>Information has been successfully saved."; // New for 0.4.8.1
        break;
      case 'delete_static':
