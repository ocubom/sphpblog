<?php 
      ...
      if ( $blog_config[ "blog_trackback_enabled" ] ) {
		...
		if ( isset( $entry_array["logged_in"] ) && $entry_array["logged_in"] == true ) {
			...
			if ( isset( $entry_array["edit"]["url"] ) ) {
				$blog_content = $blog_content . "\t\t" . '<a href="' . $entry_array["edit"]["url"] . '"><img src="' . $img_path . 'page_edit.gif" title="' . $entry_array["edit"]["name"] . '" alt="' . $entry_array["edit"]["name"] . '" width="14" height="14" /> </a>' . "\n";
			}
			if ( isset( $entry_array["delete"]["url"] ) ) {
				$blog_content = $blog_content . "\t\t" . '<a href="' . $entry_array["delete"]["url"] . '"><img src="' . $img_path . 'page_delete.gif" title="' . $entry_array["delete"]["name"] . '" alt="' . $entry_array["delete"]["name"] . '" width="14" height="14" /> </a>' . "\n";
			}
		...
		if ( isset( $entry_array["comment"]["url"] ) ) {
			...
			$comment_area = $comment_area . '<a href="' . $entry_array["comment"]["url"] . '"><img src="' . $img_path . 'comment.gif" alt="' . $entry_array["comment"]["name"] . '" width="14" height="14" align="top" /> ' . $entry_array["comment"]["name"] . ' </a>' . "\n";
		}
	...
	function theme_trackbackentry ( $entry_array ) {
		...
		if ( isset( $entry_array['logged_in'] ) && $entry_array['logged_in'] == true ) {
			...
			if ( isset( $entry_array['delete']['url'] ) ) {
				$blog_content = $blog_content . "\t\t" . '<a href="' . $entry_array['delete']['url'] . '"><img src="' . $img_path . 'note_delete.gif" alt="' . $entry_array['delete']['name'] . '" width="14" height="14" /> </a>' . "\n";
			}
